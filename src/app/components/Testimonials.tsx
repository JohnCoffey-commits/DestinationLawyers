...
const testimonials = [
  { name: "Robert Harrison", role: "CEO, Harrison Industries", text: "Destination Lawyers handled our merger with exceptional professionalism. Their attention to detail and strategic thinking saved us millions. I couldn't recommend them more highly.", rating: 5 },
  ...
  { name: "David Thompson", role: "Real Estate Developer", text: "Their real estate legal team is second to none. From property acquisitions to zoning disputes, they've been our trusted advisors for over a decade. Outstanding results, every time.", rating: 5 },
    ...
    <section id="testimonials" className="py-24 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6">
          ...
          <h2 className="mt-4 text-white" style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(2rem, 3vw, 2.75rem)", fontWeight: 700 }}>Testimonials</h2>
            ...
            {testimonials.map((testimonial, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(1.2rem, 2.2vw, 1.5rem)", fontWeight: 500, lineHeight: 1.85, fontStyle: "italic", color: color.text, marginBottom: "2.5rem" }}>
                    "{testimonial.text}"
                  </p>
